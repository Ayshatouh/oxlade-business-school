      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div className="bg-white rounded-2xl p-8 lg:p-10 shadow-sm border border-gray-100 flex flex-col items-start hover:shadow-lg transition-shadow duration-300">
            <div className="w-16 h-16 rounded-2xl bg-[#002d80]/5 flex items-center justify-center text-[#002d80] mb-6">
              <Users size={32} strokeWidth={1.5} />
            </div>
            <h2 className="text-[1.75rem] font-extrabold text-[#002d80] mb-5 leading-tight" style={{ fontFamily: "var(--font-playfair), 'Playfair Display', Georgia, serif" }}>
              Multiple Training Formats
            </h2>
